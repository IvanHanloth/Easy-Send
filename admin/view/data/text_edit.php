        ...
        <div class="pear-main">
            ...
            <form class="layui-form" action="" lay-filter="form">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="number" name="times" lay-verify="required" autocomplete="off" placeholder="请输入文本阅读次数限制" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
...
<script>
    layui.use(['form', 'laydate', 'jquery', 'layer'], function() {
        var form = layui.form,
            ...
            $ = layui.jquery;
                $.getJSON("/admin/api/data/text.php?action=edit&type=get&id=<?php echo $_REQUEST['id'] ?>", function(res) {
                    form.val('form', res)
                })
        laydate.render({
            elem: "#tillday",
        ...
        form.on('submit(btn)', function(data) {
            $.ajax({
                type: "POST",
                url: '/admin/api/data/text.php?action=edit&type=save&id=<?php echo $_REQUEST['id'] ?>',
                dataType: 'json',
                async: false,
                data: {
