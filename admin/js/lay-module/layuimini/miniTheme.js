        ...
        listen: function (options) {
            $('body').on('click', '[data-bgcolor]', function () {
                ...
                var html = '<div class="layuimini-color">\n' +
                    ...
                    '<a class="more-menu-item" href="https://github.com/IvanHanloth/Easy-Send/wiki" target="_blank"><i class="layui-icon layui-icon-read" style="font-size: 19px;"></i> 开发文档</a>\n' +
                    '<a class="more-menu-item" href="https://github.com/IvanHanloth/Easy-Send" target="_blank"><i class="layui-icon layui-icon-tabs" style="font-size: 16px;"></i> 开源地址(Github)</a>\n' +
                    '<a class="more-menu-item" href="https://gitee.com/IvanHanloth/Easy-Send" target="_blank"><i class="layui-icon layui-icon-tabs" style="font-size: 16px;"></i> 开源地址(Gitee)</a>\n' +
                    '</div>' +
                    '</div>';
                layer.open({
                    type: 1,
