...
<script>
    layui.use(function () {
        var form = layui.form
            , layer = layui.layer;
            $.getJSON("/admin/api/app_setting_get.php",function(res){
        ...
        form.on('submit(mobile_setting_save)', function (data) {
            $.ajax({
    			type: "POST",
    			url: '/admin/api/app_setting_save.php',
    			dataType: 'json',
    			async: false,
    			data:{"data":JSON.stringify(data.field),"type":"mobile"},
        ...
        form.on('submit(PC_setting_save)', function (data) {
            $.ajax({
    			...
    			dataType: 'json',
    			async: false,
    			data:{"data":JSON.stringify(data.field),"type":"PC"},
    			success:function(res){
    			    if(res.code==200){
    			        icon=1
    			    }else{
