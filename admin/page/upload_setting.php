...
<blockquote class="layui-elem-quote layui-quote-nm">
        ...
        <form class="layui-form" action="" lay-filter="cloud_setting">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="qiniu_Access_Key" lay-verify="required" autocomplete="off" placeholder="请输入七牛云Access Key" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">Secret Key</label>
                <div class="layui-input-block">
                    <input type="text" name="qiniu_Secret_Key" lay-verify="required" autocomplete="off" placeholder="请输入七牛云Secret Key" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">空间名</label>
                <div class="layui-input-block">
                    <input type="text" name="qiniu_bucket" lay-verify="required" autocomplete="off" placeholder="请输入七牛云空间名" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">空间绑定域名</label>
                <div class="layui-input-block">
                    <input type="url" name="qiniu_domain" lay-verify="required" autocomplete="off" placeholder="请输入七牛云空间绑定域名（包含http://或https://以及结尾/）" class="layui-input">
                </div>
...
<script>
    layui.use(function () {
        var form = layui.form
            , layer = layui.layer;
            $.getJSON("/admin/api/upload_setting_get.php",function(data){
            ...
            $.getJSON("/admin/api/cloud_setting_get.php",function(res){
        ...
        form.on('submit(cloud_setting_save)', function (data) {
            $.ajax({
    			type: "POST",
    			url: '/admin/api/cloud_setting_save.php',
    			dataType: 'json',
    			async: false,
    			data:{"data":JSON.stringify(data.field)},
    			success:function(res){
